...
hlData = pd.read_excel("2007-2022-PIT-Counts-by-State.xlsx", sheet_name= "2022", index_col=0)

print(hlData["Overall Homeless, 2022"]["Total"])

# get vacant house data from dataset
vhData = pd.read_excel("ann22t_11.xlsx", index_col=0)

print(vhData["2022 Estimate"]["Vacant"])
